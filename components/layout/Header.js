  ...
  return <>
    ...
    <header className="header">
      <div className="container header-row">
        ...
        <Link className="logo" href="/" aria-label="Ponnomela home"><img src="/uploads/PonnoMelaLogo.webp" alt="Ponnomela" /></Link>
    ...
    <nav className={`nav ${navStuck ? 'is-stuck' : ''}`} aria-label="Main navigation"><div className="container nav-inner"><Link className={pathname === '/' ? 'active' : ''} href="/">Home</Link><Link className={pathname === '/shop' ? 'active' : ''} href="/shop">Shop all</Link><Link className={pathname === '/combos' ? 'active' : ''} href="/combos">Combos</Link><Link className={`nav-offer ${pathname === '/flash-sale' ? 'active' : ''}`} href="/flash-sale">Flash sale</Link><Link className={pathname === '/about' ? 'active' : ''} href="/about">About</Link><Link className={pathname === '/contact' ? 'active' : ''} href="/contact">Contact</Link></div></nav>
