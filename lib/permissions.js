...
ADMIN_ROLE_TEMPLATES.ADMIN = {
  label: 'Admin',
  description: 'Administrative access without root Super Admin controls.',
  permissions: ADMIN_ROLE_TEMPLATES.ADMINISTRATOR.permissions,
};
ADMIN_ROLE_TEMPLATES.STORE_MANAGER = {
  label: 'Store Manager',
  description: 'Store operations, products, orders, and inventory access.',
  permissions: ADMIN_ROLE_TEMPLATES.MANAGER.permissions,
};
ADMIN_ROLE_TEMPLATES.STAFF = {
  label: 'Staff',
  description: 'Day-to-day order and customer support access.',
  permissions: ADMIN_ROLE_TEMPLATES.ORDER_MANAGER.permissions,
};
ADMIN_ROLE_TEMPLATES.EDITOR = {
  label: 'Editor',
  description: 'Catalogue and content management access.',
  permissions: ADMIN_ROLE_TEMPLATES.CONTENT_MANAGER.permissions,
};
