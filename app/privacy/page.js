...
export default function Privacy() {
	return <main className={styles.page}>
		<div className={styles.hero}>
			<span className={styles.eyebrow}>Ponnomela</span>
			<h1>Privacy Policy</h1>
			<p className={styles.updated}>Last Updated: September 5, 2026</p>
			<p className={styles.lead}>Ponnomela respects your privacy and is committed to handling your information responsibly. This Privacy Policy explains what information we may collect, why we use it, and the choices available to you when you use our online store.</p>
		</div>
		...
		<div className={styles.layout}>
			...
			<article className={styles.content}>
				<Section id="who-we-are" title="1. Who We Are">
					<p>Ponnomela is an online eCommerce platform serving customers in Bangladesh. We provide products, order processing, delivery coordination, account services, and customer support through our website.</p>
					<div className={styles.contactCard}><strong>Ponnomela</strong><span>Phone: <a href="tel:01608069154">01608069154</a></span><span>Address: Asim, Fulbaria, Mymensingh, Bangladesh</span></div>
				</Section>
				...
				<Section id="payment-information" title="5. Payment Information"><p>Payment information may be processed by the payment provider selected for an order. Ponnomela does not claim to store full card numbers, CVV codes, PINs, or other sensitive payment credentials unless the applicable payment process specifically requires it. For Cash on Delivery, we collect the information needed to confirm and deliver the order and collect payment.</p></Section>
				...
				<Section id="analytics" title="10. Analytics"><p>Ponnomela may use aggregated or technical website information, such as feature usage and performance information, to understand how the website works and where it can be improved. No specific external analytics service is identified in this policy unless one is configured on the website.</p></Section>
				...
				<Section id="password-security" title="14. Password and Account Security"><p>Keep your password confidential, use a strong password, and do not share your login credentials. Ponnomela will not ask you to send us your password. Contact Ponnomela through the available contact information if you suspect unauthorized access to your account.</p></Section>
				...
				<Section id="privacy-choices" title="16. Customer Privacy Choices"><p>Where applicable, customers may request access to their information, correction of inaccurate information, deletion of certain information, account updates, or information about how their data is used. You may also ask to opt out of promotional communication where applicable. Requests should be directed to Ponnomela using the contact details below. Some information may need to be retained for orders, legal requirements, security, or dispute resolution.</p></Section>
				<Section id="third-party-websites" title="17. Third-Party Websites"><p>Links from Ponnomela to external websites may be provided for convenience. Those websites may have their own privacy policies, and Ponnomela is not responsible for their privacy practices or content.</p></Section>
				<Section id="childrens-privacy" title="18. Children's Privacy"><p>Ponnomela does not intentionally seek to collect personal information from children without appropriate authorization. If you believe that a child has provided personal information improperly, please contact us so that the matter can be reviewed.</p></Section>
				<Section id="fraud-and-law" title="19. Fraud Prevention and Legal Requirements"><p>Information may be processed or disclosed when reasonably necessary to prevent fraud, detect abuse, protect customers or Ponnomela, enforce website terms, comply with applicable law, or respond to lawful requests.</p></Section>
				<Section id="changes" title="20. Changes to Privacy Policy"><p>Ponnomela may update this Privacy Policy from time to time. When it is updated, the “Last Updated” date at the top of this page will also be updated.</p></Section>
				<Section id="contact-us" title="21. Contact Us"><p>For privacy questions or requests, contact Ponnomela using the available information:</p><div className={styles.contactCard}><strong>Ponnomela</strong><span>Phone: <a href="tel:01608069154">01608069154</a></span><span>Address: Asim, Fulbaria, Mymensingh, Bangladesh</span></div><p className={styles.disclaimer}>This Privacy Policy is customer information about the website’s practices and is not legal advice.</p></Section>
			</article>
		</div>
	</main>;
}
